...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='反应罐';
...
CREATE TABLE `cost_pipeline` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='进料管道';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `equipment_base_instrument` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='设备仪器基础表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `equipment_base_manufacturer` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='设备维修、生产厂商';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `equipment_instructor_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='设备指导书';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `equipment_repair_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='设备维修申请记录\n在APP端完成\n后端需要所有想到的接口';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_base_delivery_factory` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='送检工厂表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_base_product_line` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='产品线表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_base_production_process` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='工序表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_base_test_item` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='检测项表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_common_batch_number` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='批号表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_procedure_test_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='制程检测记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_purchase_test_report_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='原料进货单记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_sample_delivering_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='样品送检记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_task` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='审核任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_test_report_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='原材料、中间品检测记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_unqualified_test_report_record` (
  ...
  `decision` int(11) DEFAULT NULL COMMENT '进货检验报告单中单条纪录和标准对比后的判定结果。\n其他时候为NULL',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='不合格审评表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_unqualified_tracing_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='不合格品跟踪表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `repo_base_serial_number` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='序号，deprecated';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `repo_in_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='入库纪录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `repo_out_apply` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='出库';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `repo_red_table` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='红单填写';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `repo_stock` (
  ...
  `weight` int(11) NOT NULL COMMENT '重量',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='库存表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `technique_base_product_class` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='产品型号';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `technique_base_raw_material` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='原材料';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `technique_raw_standard_record` (
  ...
  `effective_time` datetime DEFAULT NULL COMMENT '生效时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='原材料技术标准';
/*!40101 SET character_set_client = @saved_cs_client */;
