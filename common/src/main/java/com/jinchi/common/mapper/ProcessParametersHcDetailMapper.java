...
public interface ProcessParametersHcDetailMapper {
     ...
     */
    @Insert({
        "insert into process_parameters_hc_detail (code, process_code, ",
        "production_code, flow_standard1, ",
        "flow_bias1, flow_standard2, ",
        "flow_bias2, rotate_speed_standard, ",
        "rotate_speed_bias, temperature_standard, ",
        "temperature_bias, basicity_standard, ",
        "basicity_bias, solid_containing_content_standard, ",
        "solid_containing_content_bias, nitrogen_flow_standard, ",
        "nitrogen_flow_bias, size_d70, ",
        "size_d30_standard, size_d30_bias, ",
        "size_d90, comment, ",
        "ni, co, mn)",
        "values (#{code,jdbcType=BIGINT}, #{processCode,jdbcType=BIGINT}, ",
        "#{productionCode,jdbcType=SMALLINT}, #{flowStandard1,jdbcType=REAL}, ",
        "#{flowBias1,jdbcType=REAL}, #{flowStandard2,jdbcType=REAL}, ",
        "#{flowBias2,jdbcType=REAL}, #{rotateSpeedStandard,jdbcType=INTEGER}, ",
        "#{rotateSpeedBias,jdbcType=INTEGER}, #{temperatureStandard,jdbcType=REAL}, ",
        "#{temperatureBias,jdbcType=REAL}, #{basicityStandard,jdbcType=REAL}, ",
        "#{basicityBias,jdbcType=REAL}, #{solidContainingContentStandard,jdbcType=INTEGER}, ",
        "#{solidContainingContentBias,jdbcType=INTEGER}, #{nitrogenFlowStandard,jdbcType=INTEGER}, ",
        "#{nitrogenFlowBias,jdbcType=INTEGER}, #{sizeD70,jdbcType=VARCHAR}, ",
        "#{sizeD30Standard,jdbcType=REAL}, #{sizeD30Bias,jdbcType=REAL}, ",
        "#{sizeD90,jdbcType=VARCHAR}, #{comment,jdbcType=VARCHAR}, ",
        "#{ni,jdbcType=REAL}, #{co,jdbcType=REAL}, #{mn,jdbcType=REAL})"
    })
    ...
    @Select({
        ...
        "size_d30_standard, size_d30_bias, size_d90, comment, ni, co, mn",
