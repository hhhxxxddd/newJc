...
public enum AddressEnum {
    ...
    DEVICE_SPOTCHECK_RECORD(4,"SPOTRECORD_ABS","/spotCheck/model/"),//设备点检记录
    EXCEL_REPAIR(5,"EXCEL_REPAIR","/excel/repair/"),//设备维修
    EXCEL_FIRE_MAGE(6,"EXCEL_FIRE_MAGE","/excel/fireMage/"); //火法质量
    Integer code;
    String name;
    String path;
