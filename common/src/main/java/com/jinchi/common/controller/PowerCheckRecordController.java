...
public class PowerCheckRecordController {
    ...
    public Result page(@ApiParam(name = "start", value = "开始时间") @RequestParam(name = "start", defaultValue = "", required = false) String start,
                       ...
                       @ApiParam(name = "condition", value = "模板名称") @RequestParam(name = "condition", defaultValue = "", required = false) String condition,
        ...
        return ResultUtil.success(recordService.page(start, end, condition, page, size));
    }
