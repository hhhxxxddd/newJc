...
import com.jc.api.service.restservice.imp.SwmsStreamStatisticService;
...
public class SwmsStreamStatisticController {
    ...
    @Autowired
    SwmsStreamStatisticService service;
    ...
    public Result monthView(@RequestParam Integer year,@RequestParam Integer month){
        return Result.success(service.monthView(year,month));
    }
    ...
    public Result yearView(@RequestParam Integer year){
        return Result.success(service.yearView(year));
    }
}
