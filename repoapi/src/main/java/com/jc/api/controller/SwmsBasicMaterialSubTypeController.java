...
import com.jc.api.service.restservice.SwmsBasicMaterialSubTypeService;
...
public class SwmsBasicMaterialSubTypeController {
    ...
    @Autowired
    private SwmsBasicMaterialSubTypeService swmsBasicMaterialSubTypeService;
    ...
    public Result getAll(){
        ...
        return Result.success(swmsBasicMaterialSubTypeService.getAll(subType));
    }
