...
public class SwmsBasicPlantInfoController {
    ...
    @Autowired
    private SwmsBasicPlantInfoService swmsBasicPlantInfoService;

    @ApiOperation(value = "获取所有供应车间", notes = "获取所有供应车间")
    @ApiResponses(@ApiResponse(code = 200, message = "处理成功", response = Result.class))
    @GetMapping(value = "/getAll")
    public Result getAll(){
        return Result.success(swmsBasicPlantInfoService.getAll(new SwmsBasicPlantInfo()));
    }
    ...
    public Result query(SwmsBasicPlantInfo swmsBasicPlantInfo){
        return Result.success(swmsBasicPlantInfoService.getAll(swmsBasicPlantInfo));
    }
...
//    }
    ...
    public Result add(@Valid @RequestBody SwmsBasicPlantInfo swmsBasicPlantInfo) {
        ...
        return Result.success(swmsBasicPlantInfoService.add(swmsBasicPlantInfo));
    }
    ...
    public Result autoAdd(@RequestParam @NotBlank(message = "供应车间代号不能为空白") String plantCode) {
        return Result.success(swmsBasicPlantInfoService.autoAdd(new SwmsBasicPlantInfo().setPlantCode(plantCode)));
    }
    ...
    public Result update(@RequestBody SwmsBasicPlantInfo swmsBasicPlantInfo) {
        return Result.success(swmsBasicPlantInfoService.update(swmsBasicPlantInfo));
    }
    ...
    public Result delete(@PathVariable Integer id) {
        ...
        return Result.success(swmsBasicPlantInfoService.delete(id));
    }
}
