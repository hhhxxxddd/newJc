...
@TableName("SWMS_stock_inventory_turnover_rate_month_reports_type_total")
@ApiModel(value="SwmsStockInventoryTurnoverRateMonthReportsTypeTotal对象", description="物料库存周转率大类合计报表")
public class SwmsStockInventoryTurnoverRateMonthReportsTypeTotal extends BasePo implements Serializable {
