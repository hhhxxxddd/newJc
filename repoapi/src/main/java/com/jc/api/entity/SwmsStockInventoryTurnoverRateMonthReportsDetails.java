...
@TableName("SWMS_stock_inventory_turnover_rate_month_reports_details")
@ApiModel(value="SwmsStockInventoryTurnoverRateMonthReportsDetails对象", description="物料库存周转率明细报表")
public class SwmsStockInventoryTurnoverRateMonthReportsDetails extends BasePo implements Serializable {
